...
public class CheckboxModifier {
	...
	public ArrayList<String>[] returnResource(ArrayList<String> resources, ArrayList<String> filters, int state, String name) {
		...
		if (name == "Q-Logs" && state == 1) {
			...
			ArrayList[] returnLists = {tempResList, tempFilList}; //Apply generics here, may have to rethink
			return returnLists;
		...
		} else if (name == "H&HTC" && state == 1) {
			
			tempResList.add("HHTC"); 
			ArrayList[] returnLists = {tempResList, tempFilList};
			return returnLists;
			
		} else if (name == "H&HTC" && state == 2) {
		...
		} else if (name == "Customer Service" && state == 1) {
			
			tempResList.add("CUSE");
			ArrayList[] returnLists = {tempResList, tempFilList};
			return returnLists;
			
		} else if (name == "Customer Service" && state == 2) {
			
			tempResList.remove("CUSE");
			ArrayList[] returnLists = {tempResList, tempFilList};
			return returnLists;
		...
		} else if (name == "Practice CS" && state == 1) {
			
			tempFilList.add("PRA");
			ArrayList[] returnLists = {tempResList, tempFilList};
			return returnLists;
			
		} else if (name == "Practice CS" && state == 2) {
			
			tempFilList.remove("PRA");
			ArrayList[] returnLists = {tempResList, tempFilList};
			return returnLists;
			
		} else if (name == "Web Services" && state == 1) {
			
			tempFilList.add("WEB");
			ArrayList[] returnLists = {tempResList, tempFilList};
			return returnLists;
			
		} else if (name == "Web Services" && state == 2) {
		...
		} else if (name == "AdvanceFlow" && state == 1) {
			
			tempFilList.add("AFLO");
			ArrayList[] returnLists = {tempResList, tempFilList};
			return returnLists;
			
		} else if (name == "AdvanceFlow" && state == 2) {
			
			tempFilList.remove("AFLO");
			ArrayList[] returnLists = {tempResList, tempFilList};
			return returnLists;
			
		} else if (name == "FileCabinet" && state == 1) {
			
			tempFilList.add("FCAB");
			ArrayList[] returnLists = {tempResList, tempFilList};
			return returnLists;
			
		} else if (name == "FileCabinet" && state == 2) {
		...
		} else if (name == "2018 UltraTax" && state == 1) {
			
			tempFilList.add("UT18");
			ArrayList[] returnLists = {tempResList, tempFilList};
			return returnLists;
			
		} else if (name == "2018 UltraTax" && state == 2) {
			
			tempFilList.remove("UT18");
			ArrayList[] returnLists = {tempResList, tempFilList};
			return returnLists;
